...
def save_file(uploaded_file: UploadedFile) -> str:
    """Saves the uploaded .csv file locally.

    :param uploaded_file: .csv file the user uploads
...
def create_page_two():
    ...
    if uploaded_file is not None:
        data_path = save_file(uploaded_file)
        ...
        save_filtered_df = st.checkbox("**Save results**")
